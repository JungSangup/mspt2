...
- `kubectl logs ~`의 결과에서 맨 앞의 이니셜은 뭔가요? ( I0118 01:41:10.313042       1 serving.go:348] Generated self-signed cert in-memory )
  ...
  - [시스템 로그](https://kubernetes.io/ko/docs/concepts/cluster-administration/system-logs/) [Text logging format](https://github.com/kubernetes/community/blob/master/contributors/devel/sig-instrumentation/logging.md#text-logging-format) 참고하세요.
...
- Pod Condition에서 Container ready와 ready의 차이는 뭔가요?
